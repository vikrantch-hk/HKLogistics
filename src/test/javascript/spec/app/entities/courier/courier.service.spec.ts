    ...
    describe('Courier Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/couriers';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Courier', () => {
                service.create(new Courier(null)).subscribe(received => {
            ...
            it('should update a Courier', () => {
                service.update(new Courier(123)).subscribe(received => {
