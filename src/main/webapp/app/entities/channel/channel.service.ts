...
export class ChannelService {
    ...
    private resourceSearchUrl = SERVER_API_URL + 'api/_search/channels';
    ...
    search(req?: any): Observable<HttpResponse<Channel[]>> {
        const options = createRequestOption(req);
        return this.http.get<Channel[]>(this.resourceSearchUrl, { params: options, observe: 'response' })
            .map((res: HttpResponse<Channel[]>) => this.convertArrayResponse(res));
    }
